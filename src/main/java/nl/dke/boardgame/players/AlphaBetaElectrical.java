...
//        }
    ...
    public BoardPlusScore alphaBeta(int depth,double alpha, double beta, AbBoard boardAB, TileState t){
        if(depth == 0 ){
    ...
    class BoardPlusScore{
        ...
        public BoardPlusScore(AbBoard board, double score){
            this.board = board;
            this.score = score;
        }
    }
    ...
    public AdjacencyList getAdjacencyGraph(AbBoard board, TileState tileState){
    ...
    public double evaluateBoardElectrical(AbBoard board, TileState claimer){
