...
import nl.dke.boardgame.game.board.AbBoard;
...
public class AlphaBetaDijkstra extends HexPlayer {
    ...
    public void finishMove(Move move) {
        AbBoard currentBoard = new AbBoard(move.getBoard());
...
//        }
    ...
    public BoardPlusScore alphaBeta(int depth,int alpha, int beta, AbBoard boardAB, TileState t){
        if(depth == 0 ){
        ...
        ArrayList<AbBoard> allPossibleBoards = boardAB.getAllPossibleBoardsAfter1Move(t);

        if(t == maximizer){
            int bestScore = Integer.MIN_VALUE;
            for(AbBoard b : allPossibleBoards){
    ...
    class BoardPlusScore{
        ...
        public BoardPlusScore(AbBoard board){
            this.board = board;
        }
        public BoardPlusScore(AbBoard board, int score){
            this.board = board;
            this.score = score;
        }
    }
    ...
    public int[][] getGraph(AbBoard board, TileState tilestate) {
    ...
    public int evaluateBoard(AbBoard board, TileState claimer){
        /*
...
//            System.out.println("so score for player 2 is: " + result);
    ...
    public int getEdgeValue(AbBoard board, int row1, int column1, int row2, int column2, TileState tilestate) {
    ...
    public int getEdgeValue(AbBoard board, int row1, int column1, int value, TileState tilestate) {
        int valueTileOne = getVertexValue(tilestate, board, row1, column1);
