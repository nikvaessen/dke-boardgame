...
\section{Introduction}
 ...
 or left to right. The game was first created in 1942, and improved into the version we know today in 1947. As the game is fully determined, as connecting one player's path will block the other, it is an ideal candidate to create an AI for.\\ 
